...
export default function InvoicesReport() {
    ...
    const columns = [
        ...
        { headerName: 'Bill Date', field: 'invoiceDate', valueGetter: (params) => params.data?.invoiceDate ? moment(params.data?.invoiceDate).format("DD/MM/YYYY HH:mm:ss") : "Not Available" },
