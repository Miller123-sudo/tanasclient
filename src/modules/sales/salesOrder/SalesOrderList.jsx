...
export default function SalesOrderList() {
    ...
    const columns = [
        ...
        { headerName: 'Vendor', field: 'customer.name', flex: 1 },
        ...
        { headerName: 'Receipt Date', field: 'deliveryDate', flex: 1, valueGetter: (params) => params.data?.deliveryDate ? moment(params.data?.deliveryDate).format("DD/MM/YYYY HH:mm:ss") : "Not Available" },
